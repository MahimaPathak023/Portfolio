...
const container = document.getElementById("photodiv");
  ...
  const circle = document.querySelector("#clickdiv");
  ...
  document.querySelector("#page5").addEventListener("mouseleave", function (e) {
    document.querySelector("#clickdiv").style.top = `5%`;
    document.querySelector("#clickdiv").style.left = `5%`;
  })
